...
% 9/18/2022 - Made Current - Reflects JHUAPL Employment
...
\section*{Awards}
\begin{tabular}{L!{\grayrule}R}
2022&{\bf Publication Award}\\
&{\emph{Johns Hopkins University Applied Physics Lab Achievement Awards}}\vspace{5pt}\\
&A 32-channel frequency-domain fNIRS system based on silicon photomultiplier receivers\vspace{5pt}\\
2022&{\bf Ignition Grant Prize for Innovation}\\
&{\emph{Johns Hopkins University Applied Physics Lab Achievement Awards}}\vspace{5pt}\\
&Multifaceted Intentional Natural Drone (MIND) Control\vspace{5pt}\\
...
\begin{tabular}{L!{\grayrule}R}
2021
&\bibentry{milsap_technical_2021}\vspace{5pt}\\
&\bibentry{wathen_32-channel_2021}\vspace{5pt}\\
&\bibentry{thompson_phase_2021}\vspace{5pt}\\
&\bibentry{scholl_evaluation_2021}\vspace{5pt}\\
2020
...
\subsection*{Selected Articles: Continued}
\begin{tabular}{L!{\grayrule}R}
2015
...
\begin{tabular}{L!{\grayrule}R}
2018-
&Introduction to Brain Computer Interfaces.  Johns Hopkins University Whiting School of Engineering.  Engineering for Professionals Program.  Summer Course. \vspace{5pt}\\
2017
...
\begin{tabular}{L!{\grayrule}R}
\bf ezmsg&A high-performance publication-subscription framework for modular neural signal processing in Python.\\
&\url{https://github.com/iscoe/ezmsg/}\vspace{5pt}\\
